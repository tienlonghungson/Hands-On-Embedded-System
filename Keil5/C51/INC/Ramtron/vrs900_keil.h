/***************************************************************************\
*         VRS900 SFR Definitions for the Keil uVision2 C51 Compiler         *
*****************************************************************************
* Rev Number:        1.0                                                    *
* Date:              September 2004                                         *
*                                                                           *
...
#ifndef __VRS900_Keil_H__
#define __VRS900_Keil_H__
...
sfr    ADCCTRL  = 0x8E;    // Analog Digital Converter Control
sfr    ADCDATA  = 0x8F;    // Analog Digital Converter Data
sfr    P1       = 0x90;    // Port 1

sfr    WDTKEY   = 0x97;    // Watchdog Timer Key
sfr    SCON     = 0x98;    // Serial Port Control
sfr    SBUF     = 0x99;    // Serial Port Rx/Tx Buffer
sfr    P0IOCTRL = 0x9A;    // Port 0 Input - Output Control
sfr    P1IOCTRL = 0x9B;    // Port 1 Input - Output Control
sfr    P2IOCTRL = 0x9C;    // Port 2 Input - Output Control
sfr    P3IOCTRL = 0x9D;    // Port 3 Input - Output Control

sfr    WDTCTRL  = 0x9F;    // Watchdog Timer Control
sfr    P2       = 0xA0;    // Port 2

sfr    PWMACTRL = 0xA3;    // Pulse Width Modulator A Control
sfr    PWMA     = 0xA4;    // Pulse Width Modulator A

sfr    IEN0     = 0xA8;    // Interrupt 0 Enable
sfr    IEN1     = 0xA9;    // Interrupt 1 Enable
sfr    IF1      = 0xAA;    // Interrupt 1 Flags

sfr    PWMD4    = 0xAC;    // Pulse Width Modulation Data Register 4

sfr    P3       = 0xB0;    // Port 3

sfr    PWMB     = 0xB3;    // Pulse Width Modulator B
...
sfr    PWMBCTRL = 0xD3;    // Pulse Width Modulator B Control

sfr    P4       = 0xD8;    // Port 4

sfr    LCDCTRL  = 0xDF;    // LCD Control
sfr    ACC      = 0xE0;    // Accumulator
sfr    LCDBUF0  = 0xE1;    // LCD Buffer 0
sfr    LCDBUF1  = 0xE2;    // LCD Buffer 1
sfr    LCDBUF2  = 0xE3;    // LCD Buffer 2
sfr    LCDBUF3  = 0xE4;    // LCD Buffer 3
sfr    LCDBUF4  = 0xE5;    // LCD Buffer 4
sfr    LCDBUF5  = 0xE6;    // LCD Buffer 5
sfr    LCDBUF6  = 0xE7;    // LCD Buffer 6

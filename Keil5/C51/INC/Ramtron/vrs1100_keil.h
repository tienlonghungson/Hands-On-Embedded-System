/***************************************************************************\
*        VRS1100 SFR Definitions for the Keil uVision2 C51 Compiler         *
*****************************************************************************
* Rev Number:        1.0                                                    *
* Date:              September 2004                                         *
*                                                                           *
...
#ifndef __VRS1100_Keil_H__
#define __VRS1100_Keil_H__
...
sfr    MPAGE    = 0x85;    // Memory Page (extra read data pointer)
...
sfr    PWME     = 0x9B;    // Pulse Width Modulation Enable
...
sfr    IAPFCTRL = 0xF7;    // In Application Programmer Flash Control
...
// FlashWrite() writes a byte to the specified address

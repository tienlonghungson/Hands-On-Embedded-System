//======================================================
//		file name: MC96FT083.h
//		device   : MC96FT083, MC96FT084
//		version  : Ver1.2 
//		date     : 2015-10.01.Thu
//		compiler : Keil-C
//======================================================
...
unsigned char xdata PSR0 _at_ 0x2F50;	// ADC Channel 0~7 Port Selection Register
unsigned char xdata PSR1 _at_ 0x2F51;	// ADC Channel 8~14 Port Selection Register
unsigned char xdata PSR2 _at_ 0x2F52;	// I2C, USART Port Change Selection Register
...
sfr			TSCRL		= 0xE3;			// Touch Switch Control Register Low
sfr			TSDR		= 0xE4;			// Touch Switch Data Register
sfr			TSRXER		= 0xE5;			// Touch Switch Receiving Enable Register
sfr			TSTXER		= 0xE6;			// Touch Switch Transmission Enable Register
sfr			TSSR0		= 0xB1;			// Touch Switch Sensitivity Register 0
sfr			TSSR1		= 0xB9;			// Touch Switch Sensitivity Register 1
sfr			TSSR2		= 0xC1;			// Touch Switch Sensitivity Register 2
sfr			TSSR3		= 0xC9;			// Touch Switch Sensitivity Register 3
sfr			TSSR4		= 0xD1;			// Touch Switch Sensitivity Register 4
sfr			TSSR5		= 0xD9;			// Touch Switch Sensitivity Register 5
sfr			TSSR6		= 0xE1;			// Touch Switch Sensitivity Register 6
sfr			TSSR7		= 0xE9;			// Touch Switch Sensitivity Register 7
sfr			TSSR8		= 0xF1;			// Touch Switch Sensitivity Register 8

// External low voltage interrupt
sfr			EXTLVD		= 0x8F;			// TEXTLVD Register

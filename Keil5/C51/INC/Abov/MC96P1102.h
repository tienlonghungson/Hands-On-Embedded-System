...
sfr			P0OD		= 0x93;			// P0 Open-drain Selection Register
sfr			P0DBL		= 0x94;			// P0 Debounce Enable Low Register
sfr			P0DBH		= 0x95;			// P0 Debounce Enable High Register
...
sfr			P1IO		= 0x99;			// P1 Direction Register
sfr			P1PU		= 0x9A;			// P1 Pull-up Resistor Selection Register
sfr			P1OD		= 0x9B;			// P1 Open-drain Selection Register
...
sfr			EIPOL0		= 0x98;			// External Interrupt Polarity Register 0
sfr			EIPOL1		= 0xB1;			// External Interrupt Polarity Register 1

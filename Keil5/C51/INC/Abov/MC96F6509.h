...
sfr			P1FSRL		= 0xF6;			//Port Function Selection Register 1 low
sfr			P1FSRH		= 0xF7;			//Port Function Selection Register 1 high
...
// TIMER 4 Control	: Not exist in 96F6508A
sfr			T4CRH		= 0xC9;			// Timer 4 Control High Register
sfr			T4CRL		= 0xC8;			// Timer 4 Control Low Register
sfr			T4ADRH		= 0xD3;			// Timer 4 A Data High Register
sfr			T4ADRL		= 0xD2;			// Timer 4 A Data Low Register
sfr			T4BDRH		= 0xDF;			// Timer 4 B Data High Register
sfr			T4BDRL		= 0xDE;			// Timer 4 B Data Low register
...
// ADC Control		: Not exist in 96F6508A
sfr			ADCCRH		= 0x9D;			// A/D Converter Control High Register
sfr			ADCCRL		= 0x9C;			// A/D Converter Control Low Register
sfr			ADCDRH		= 0xA7;			// A/D Converter Data High Register
sfr			ADCDRL		= 0xA6;			// A/D Converter Data Low register

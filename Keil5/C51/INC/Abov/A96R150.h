...
unsigned char xdata PMISC2 _at_ 0x2f13;	// Port Miscellaneous 2 Register
unsigned char xdata PMISC3 _at_ 0x2f14;	// Port Miscellaneous 3 Register
#else
extern unsigned char xdata PMISC0;
extern unsigned char xdata PMISC1;
extern unsigned char xdata PMISC2;
extern unsigned char xdata PMISC3;
#endif
...
#ifdef MAIN
unsigned char xdata RMR2 _at_ 0x2F56;	// Remocon Mode Register 2
#else
...
sfr			P0STR		= 0x92;			// Port0 T-key strobe enable Register
sfr			P1STR		= 0x93;			// Port1 T-key strobe enable Register
...
#ifdef MAIN
unsigned char xdata UCTRL04 _at_ 0x2F5A;	// USART0 Control 4 Register
#else
...
sfr			I2CCR1		= 0xA4;			// I2C Slave Hold time disable

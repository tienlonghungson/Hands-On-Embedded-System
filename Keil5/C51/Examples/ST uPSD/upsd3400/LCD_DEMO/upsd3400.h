...
DEFINE_SFR(CCON1,0xFA)      // PLL Clock Control
...
// --- USB SFRs -----
DEFINE_SFR(UADDR,0xE2)      // USB Address Register
DEFINE_SFR(UPAIR,0xE3)      // USB Pairing Control
DEFINE_SFR(UIE0,0xE4)       // USB Global Interrupt Enable
DEFINE_SFR(UIE1,0xE5)       // USB IN FIFO Interrupt Enable
DEFINE_SFR(UIE2,0xE6)       // USB OUT FIFO Interrupt Enable
DEFINE_SFR(UIE3,0xE7)       // USB IN FIFO NAK Interrupt Enable
DEFINE_SFR(UIF0,0xE8)       // USB Global Interrupt Flag
DEFINE_SFR(UIF1,0xE9)       // USB IN FIFO Interrupt Flag
DEFINE_SFR(UIF2,0xEA)       // USB OUT FIFO Inerrupt Flag
DEFINE_SFR(UIF3,0xEB)       // USB IN FIFO NAK Interrupt Flag
DEFINE_SFR(UCTL,0xEC)       // USB Control Register
DEFINE_SFR(USTA,0xED)       // USB Status
DEFINE_SFR(USEL,0xEF)       // USB Endpoint Control
DEFINE_SFR(UCON,0xF1)       // USB Endpoint Control
DEFINE_SFR(USIZE,0xF2)      // USB FIFO Valid Size
DEFINE_SFR(UBASEH,0xF3)     // USB Base Address Register High
DEFINE_SFR(UBASEL,0xF4)     // USB Base Address Register Low
DEFINE_SFR(USCI,0xF5)       // USB Setup Command Index
DEFINE_SFR(USCV,0xF6)       // USB Setup Command Value
...
DEFINE_SFR_BIT(ES,IE^4)	    // UART 0	
DEFINE_SFR_BIT(ES0,IE^4)    // UART 0 (ES also known as ES0)	
...
DEFINE_SFR_BIT(PS,IP^4)     // UART 0
DEFINE_SFR_BIT(PS0,IP^4)    // UART 0 (PS also known as PS0)
...
/*  UIF0 */                     // USB Global Interrupt Flags
DEFINE_SFR_BIT(GLF,UIF0^7)      // Global USB Interrupt Flag
DEFINE_SFR_BIT(INF,UIF0^6)      // IN FIFO Interrupt Flag
DEFINE_SFR_BIT(OUTF,UIF0^5)     // OUT FIFO Interrupt Flag
DEFINE_SFR_BIT(NAKF,UIF0^4)     // NAK Interrupt Flag
DEFINE_SFR_BIT(RSTF,UIF0^3)     // USB Reset Interrupt Flag
DEFINE_SFR_BIT(SUSPNDF,UIF0^2)  // USB Suspend Mode Interrupt Flag
DEFINE_SFR_BIT(EOPF,UIF0^1)     // End of Packet Interrupt Flag
DEFINE_SFR_BIT(RESUMF,UIF0^0)   // Resume Interrupt Flag

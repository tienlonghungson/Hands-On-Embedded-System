...
dofile(e.."ML51.lua")
function get_chip_status_ML51_AE_TSSOP28(i,e,e)
local a={}
...
e={}
e["pin_no"]="15"
e["texts"]={"PWM0_CH3","UART1_RXD","I2C1_SDA","ACMP1_N0,ADC_CH3","P2.2"}
if o==0 then
fill_ML51_GPIO(e,t,2,2)
elseif o==1 then
fill_ML51_Analog(e,t,2,2,"ACMP1_N0,ADC_CH3",{},{1})
elseif o==4 then
...
e={}
e["pin_no"]="16"
e["texts"]={"PWM0_BRAKE","PWM1_CH4","PWM0_CH4","I2C1_SCL","UART2_TXD","ACMP1_P2,ACMP0_P2,ADC_CH4","P2.1"}
if o==0 then
fill_ML51_GPIO(e,t,2,1)
elseif o==1 then
fill_ML51_Analog(e,t,2,1,"ACMP1_P2,ACMP0_P2,ADC_CH4",{},{})
elseif o==7 then
...
e={}
e["pin_no"]="8"
e["texts"]={"P3.2","ADC_CH7,ACMP1_N1","SPI1_CLK","UART3_RXD","PWM1_CH1","IC2","CLO"}
if o==0 then
fill_ML51_GPIO(e,t,3,2)
elseif o==1 then
fill_ML51_Analog(e,t,3,2,"ADC_CH7,ACMP1_N1",{},{1})
elseif o==4 then
